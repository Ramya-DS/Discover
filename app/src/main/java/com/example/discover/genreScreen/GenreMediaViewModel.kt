...
class GenreMediaViewModel(private val mApplication: Application) : AndroidViewModel(mApplication) {
    ...
    fun genreRelatedMovies(genreId: Int, page: Int): LiveData<List<MoviePreview>> {
        val call = genreMediaApiCall.getGenreRelatedMovies(genreId, page)
    ...
    fun genreRelatedShows(genreId: Int, page: Int): LiveData<List<ShowPreview>> {
        val call = genreMediaApiCall.getGenreRelatedShows(genreId, page)
